...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://michalgubera.github.io/";
...
//        driver.navigate().refresh();
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("michagubera");
        driverTrello.findElement(By.id("password")).sendKeys("Kodilla_App");
